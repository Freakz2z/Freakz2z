...
<p align="center">真实项目、实验和工具。点击项目名即可进入仓库。</p>
...
<table align="center">
  <tr>
    ...
    <td align="center" width="50%">
      ...
      <p>离线优先的 JSONL Agent 轨迹评测器，在没有模型和 API Key 的环境里验证工具调用、输出与预算。</p>
  ...
  <tr>
    <td align="center" width="50%">
      ...
      <p>基于 YOLOv11 与 Django 的深度伪造检测平台，支持图片、视频、历史记录与检测报告。</p>
    ...
    <td align="center" width="50%">
      ...
      <p>由 YOLO 与 CLIP 驱动的开放词汇目标检测桌面应用，用自然语言描述想要识别的对象。</p>
  ...
  <tr>
    <td align="center" colspan="2">
      ...
      <code>TypeScript</code> · <code>Bilibili Toy</code> · <code>Cloudflare</code><br/><br/>
